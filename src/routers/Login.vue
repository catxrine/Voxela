...
<template>
  ...
  >
    <div
      class="flex flex-col border-t-8 border-gray-800 bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-xl w-50 w-md"
    >
      <div
        class="mb-1 font-medium self-center text-xl sm:text-3xl text-gray-800"
      >
        Welcome to Voxela
      </div>
      <hr />
